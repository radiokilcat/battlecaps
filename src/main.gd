...
@onready var caps_container = $CapsContainer
@onready var cap_scene = preload("res://scenes/cap.tscn")
@onready var mode_1_button = $CanvasLayer/mode_1
@onready var mode_2_button = $CanvasLayer/mode_2
@onready var mode_3_button = $CanvasLayer/mode_3
@onready var mode_4_button = $CanvasLayer/mode_4
@onready var impulseLabel = $CanvasLayer/impulse
@onready var impulseSlider = $CanvasLayer/impulseSlider
@onready var label_player1: Label = $UI/Label_Player1
@onready var label_player2: Label = $UI/Label_Player2
@onready var label_up := $CanvasLayer/sumUp
...
func _unhandled_input(event):
	if event is InputEventMouseButton and event.pressed and event.button_index == MOUSE_BUTTON_LEFT and throw_bat:
		drop_cap_straight_down()
...
func stack_caps():
	...
	for i in range(cap_count):
		...
		cap_instance.position = start_position + vertical_offset
